...
class phoneval extends StatefulWidget {
  static const String id = 'phoneval';
  @override
  _phoneval createState() => _phoneval();
}

class _phoneval extends State<phoneval> {
 ...
 late LanguageChangeProvider appLanguage ;
  ...
  Widget build(BuildContext context) {
    return FirebasePhoneAuthProvider( child:
     Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
