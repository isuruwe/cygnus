        ...
        builder: (BuildContext context, BoxConstraints constraints) {
          return new OverlayBuilder(
            ...
            overlayBuilder: (BuildContext overlayContext) {
              ...
              return  !anchorBounds.top.isNaN? overlayBuilder(overlayContext, anchorBounds, anchorCenter):Container();
            },
            child: child,
          );
        },
...
class _OverlayBuilderState extends State<OverlayBuilder> {
  ...
  void initState() {
    super.initState();
    //overlayEntry=new OverlayEntry(builder: widget.overlayBuilder);
