...
import 'package:cygnus/hook/scr/photo_browser.dart';
          ...
          children: <Widget>[
            new Expanded(
              ...
              children: <Widget>[
                ...
                new Text(
                  widget.profile.location!=null?widget.profile.location:'',
                  style: TextStyle(
                      fontSize: 14.0,
                      color: Colors.white,
                ...
                new Text(
                  widget.profile.bio!=null?widget.profile.bio.replaceFirst(RegExp(r"\.[^]*"), "")+'% Match':'0%',
                  style: TextStyle(
                      fontSize: 14.0,
                      color: Colors.white,
                      fontWeight: FontWeight.w400),
